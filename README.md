...
## 📖 Project Overview
The project demonstrates how to perform **stratified random sampling of pharmacovigilance cases from database** across different report types (Clinical Trial, Spontaneous, Others) with **configurable sample sizes**.  
The project is designed for **audit reviews, retrospective analysis, and QA validation** — ensuring reproducibility, compliance, and efficiency in drug safety workflows.
...
# 📌 Use Cases
- Retrospective case analysis in **pharmacovigilance**  
